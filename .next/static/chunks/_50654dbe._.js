...
function DashboardPage() {
    ...
    const handleFormSubmit = async (e)=>{
        ...
        try {
            setLoading(true);
            setError(null);
            // Öncelikle token'ı yenileyelim
            console.log('Cari kayıt için token yenileniyor...');
            let token;
            try {
                token = await handleTokenRefresh(false); // sessiz yenileme
            ...
            console.log('Cari kayıt isteği gönderiliyor...');
            console.log('Token kullanılıyor, token başlangıcı:', token.substring(0, 20) + '...');
            ...
            if (result.IsSuccessful) {
                ...
                console.error('Cari kayıt işlemi başarısız:', result);
