    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const loadCariData = async ()=>{
            try {
                setLoading(true);
                setError(null);
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchArps"])(token);
                console.log('Cari listesi alındı:', response);
                if (response && response.IsSuccessful && response.Data) {
                    setCariList(response.Data);
                } else {
                    setError('Cari listesi alınamadı');
                }
            } catch (err) {
                console.error('Cari listesi yüklenirken hata:', err);
                setError('Cari listesi yüklenirken bir hata oluştu');
            } finally{
                setLoading(false);
            }
        };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__215cee7c._.js.map